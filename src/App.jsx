...
const saveKey = 'sauna-crowd-alert.saved'
const postKey = 'sauna-crowd-alert.posts'
const alerts = [
  {
    "id": "sauna-crowd-alert-1",
    "title": "混雑 alert seed 1",
    "area": "名古屋",
    "category": "混雑",
    "score": 95,
    "summary": "混雑、ロウリュ、イベント、回数券、深夜営業を通知し、施設送客、物販、宿泊へつなげる。 混雑の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "sauna-crowd-alert-2",
    "title": "ロウリュ alert seed 2",
    "area": "東京",
    "category": "ロウリュ",
    "score": 92,
    "summary": "混雑、ロウリュ、イベント、回数券、深夜営業を通知し、施設送客、物販、宿泊へつなげる。 ロウリュの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "sauna-crowd-alert-3",
    "title": "イベント alert seed 3",
    "area": "大阪",
    "category": "イベント",
    "score": 89,
    "summary": "混雑、ロウリュ、イベント、回数券、深夜営業を通知し、施設送客、物販、宿泊へつなげる。 イベントの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "sauna-crowd-alert-4",
    "title": "回数券 alert seed 4",
    "area": "静岡",
    "category": "回数券",
    "score": 86,
    "summary": "混雑、ロウリュ、イベント、回数券、深夜営業を通知し、施設送客、物販、宿泊へつなげる。 回数券の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">サウナ混雑・ロウリュ通知</p>
          <h1>Sauna Crowd Alert</h1>
          <p className="lead">混雑、ロウリュ、イベント、回数券、深夜営業を通知し、施設送客、物販、宿泊へつなげる。</p>
        </div>
        <aside className="hero-panel">
          <span>saunacrowd.jp / sauna-crowd-alert</span>
